		...
		var boundModule = {
			...
			mount: function mount() {
				...
				runPlugin('moduleImport', name).catch(function (error) {
					...
					state.destruct = runPlugin('moduleGetDestructor', module);

					runPlugin('moduleGetConstructor', module).apply(undefined, _toConsumableArray(runPlugin('moduleSetConstructorArguments', name, element)));
